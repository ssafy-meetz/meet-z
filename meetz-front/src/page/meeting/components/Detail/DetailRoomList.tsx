          ...
          starList.map((star) => (
            ...
            >
              <div className='flex justify-between'>
                ...
                <span className='text-2xl text-[#ff4f5d]'>{star.name}</span>
                <CopyToClipboard
                  text={`이메일 : ${star.email}\n비밀번호 : ${star.password}`}
                ...
                >
                  <div
                    ...
                    className='mt-auto flex justify-center items-center w-[30px] h-[30px] cursor-pointer rounded-full transition-colors duration-200 text-gray-400 hover:text-[#ff4f5d] active:scale-110'
                  >
                    {!isClicked ? (
                      <HiOutlineClipboardDocumentList className='w-[23px] h-[23px]' />
                    ) : (
