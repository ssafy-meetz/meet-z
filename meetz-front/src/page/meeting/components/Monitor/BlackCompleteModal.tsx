...
const BlackCompleteModal = () => {
  const { closeBlackCompleteModalOpened } = useMonitorStore();
      ...
      >
        <div className='flex flex-col gap-6'>
          ...
          <div className='flex justify-center gap-5'>
            <button
              onClick={closeBlackCompleteModalOpened} // 모달 닫기
...
export default BlackCompleteModal